...
The `esquisse` [@esquisse] package creates a GUI in `r` for graphs, allowing users to interact with the `ggally` package using drag-and-drop operations rather than strictly `r` code.
